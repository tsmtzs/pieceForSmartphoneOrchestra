...
([^blackwell], [^blackwell-bentley], [^blackwell-young]) and *artificial ecosystems* ([^bown-cormack], [^cormack]).
An overview of biologically inspired music systems can be found in [^eldridge-bown].
...
Holland ([^holland] ch. 1) refers to these interacting elements as *agents*.
Localized interactions among the agents may lead to aggregate patterns of behaviour. This phenomenon is called *emergence*([^miller-page], ch. 4).
...
offers the clues to construct the *internal model* ([^holland], ch. 1) of the agent.
...
reaction (see Miller[^miller-page], ch. 10). It encompasses sound, gestures and any related conversation between the players
during the preparation of the piece.
Closely related is the system property of *flows* (Holland[^holland], chap. 1). This is an
evolving web of interactions that "*reflects changing adaptions as time elapses and experience accumulates*".(ibid.[^holland])

Siegenfeld - Bar-Yam regard the complexity of a system to depend on the number of possible behaviours that the system
can exhibit[^siegenfeld-yam]. Behaviour depends on scale. We are interested in the acoustic behaviour of the system during a performance.
...
[^eldridge-bown]: Eldridge, Alice, and Oliver Bown. “Biologically Inspired and Agent-Based Algorithms for Music.” Oxford Handbooks Online, 2018. https://doi.org/10.1093/oxfordhb/9780190226992.013.18
...
[^miller-page]: Miller JH, Page SE. *Complex adaptive systems: an introduction to computational models of social life*. Princeton, NJ: Princeton University Press; 2007.
...
[^holland]: Holland JH. *Hidden order: how adaptation builds complexity*. Cambridge, MA: Perseus Books; 2003.
