...
\item Try to identify possible auditory distortion products.
...
\item The number of the performers should be greater than or equal to five.
...
\item Αναζήτησε πιθανές ωτοακουστικές εκπομπές προϊόντων ακουστικής παραμόρφωσης.
